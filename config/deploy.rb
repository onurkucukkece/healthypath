  ...
  task :export do
    on roles(:app) do
      within release_path do
        as :istateasedev do
          execute "cd /var/www/html/healthypath/current && /home/istateasedev/.rvm/wrappers/ruby-2.2.1@global/bundle exec foreman export supervisord /etc/supervisor/conf.d \
            -f ./Procfile \
